package com.example.weatherlushinaanastasiya;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText search_txt;
    FloatingActionButton search_floating_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_txt = findViewById(R.id.etSearch);
        search_floating_btn = findViewById(R.id.floatingSearchButton);
        search_floating_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                api_key(String.valueOf(search_txt.getText()));
            }
